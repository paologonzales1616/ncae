...
class ClericalEasyAnswerPage extends StatefulWidget {
  ClericalEasyAnswerPage({
  ...
  @override
  _ClericalEasyAnswerPageState createState() => _ClericalEasyAnswerPageState();
}

class _ClericalEasyAnswerPageState extends State<ClericalEasyAnswerPage> {
