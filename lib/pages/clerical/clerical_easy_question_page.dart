...
import 'package:ncae/pages/clerical/clerical_easy_answer_page.dart';

class ClericalEasyQuestionPage extends StatefulWidget {
  @override
  _ClericalEasyQuestionPageState createState() =>
      _ClericalEasyQuestionPageState();
}

class _ClericalEasyQuestionPageState extends State<ClericalEasyQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ClericalEasyAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
