...
class ScienceHardAnswerPage extends StatefulWidget {
  ScienceHardAnswerPage({
  ...
  @override
  _ScienceHardAnswerPageState createState() => _ScienceHardAnswerPageState();
}

class _ScienceHardAnswerPageState extends State<ScienceHardAnswerPage> {
