...
import 'package:ncae/pages/science/science_easy_answer_page.dart';

class ScienceEasyQuestionPage extends StatefulWidget {
  @override
  _ScienceEasyQuestionPageState createState() =>
      _ScienceEasyQuestionPageState();
}

class _ScienceEasyQuestionPageState extends State<ScienceEasyQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ScienceEasyAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
