...
import 'package:ncae/pages/science/science_average_answer_page.dart';

class ScienceAverageQuestionPage extends StatefulWidget {
  @override
  _ScienceAverageQuestionPageState createState() =>
      _ScienceAverageQuestionPageState();
}

class _ScienceAverageQuestionPageState
    extends State<ScienceAverageQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ScienceAverageAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
