...
import 'package:ncae/pages/verbal/verbal_answer_page.dart';

class VerbalQuestionPage extends StatefulWidget {
  @override
  _VerbalQuestionPageState createState() => _VerbalQuestionPageState();
}

class _VerbalQuestionPageState extends State<VerbalQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text(
                          "1. My mother and father ____ for the same company."),
                      ButtonTheme(
                ...
                child: ButtonTheme(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => VerbalAnswerPage(
                          answer_1: answer_1,
                          answer_2: answer_2,
                          answer_3: answer_3,
                          answer_4: answer_4,
