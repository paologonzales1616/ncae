...
class VerbalAverageAnswerPage extends StatefulWidget {
  VerbalAverageAnswerPage({
  ...
  @override
  _VerbalAverageAnswerPageState createState() => _VerbalAverageAnswerPageState();
}

class _VerbalAverageAnswerPageState extends State<VerbalAverageAnswerPage> {
            ...
            children: <Widget>[
              ...
              Card(
                child: Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text(
                    "Answer:     More exciting to watch in action ",
                    style: TextStyle(fontSize: 18.0),
                  ),
                ),
              ),
