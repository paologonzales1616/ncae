...
import 'package:ncae/pages/verbal/verbal_hard_answer_page.dart';

class VerbalHardQuestionPage extends StatefulWidget {
  @override
  _VerbalHardQuestionPageState createState() => _VerbalHardQuestionPageState();
}

class _VerbalHardQuestionPageState extends State<VerbalHardQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => VerbalHardAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
