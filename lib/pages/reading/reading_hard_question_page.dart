...
import 'package:ncae/pages/reading/reading_hard_answer_page.dart';

class ReadingHardQuestionPage extends StatefulWidget {
  @override
  _ReadingHardQuestionPageState createState() =>
      _ReadingHardQuestionPageState();
}

class _ReadingHardQuestionPageState extends State<ReadingHardQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ReadingHardAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
