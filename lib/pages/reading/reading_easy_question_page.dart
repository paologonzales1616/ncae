...
import 'package:ncae/pages/reading/reading_easy_answer_page.dart';

class ReadingEasyQuestionPage extends StatefulWidget {
  @override
  _ReadingEasyQuestionPageState createState() =>
      _ReadingEasyQuestionPageState();
}

class _ReadingEasyQuestionPageState extends State<ReadingEasyQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ReadingEasyAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
