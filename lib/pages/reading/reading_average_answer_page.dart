...
class ReadingAverageAnswerPage extends StatefulWidget {
  ReadingAverageAnswerPage({
  ...
  @override
  _ReadingAverageAnswerPageState createState() => _ReadingAverageAnswerPageState();
}

class _ReadingAverageAnswerPageState extends State<ReadingAverageAnswerPage> {
