...
import 'package:ncae/pages/mathematics/mathematic_hard_answer_page.dart';

class MathematicsHardQuestionPage extends StatefulWidget {
  @override
  _MathematicsHardQuestionPageState createState() =>
      _MathematicsHardQuestionPageState();
}

class _MathematicsHardQuestionPageState
    extends State<MathematicsHardQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => MathematicsHardAnswerPage(
                        answer_1: answer_1,
                        answer_2: answer_2,
                        answer_3: answer_3,
                        answer_4: answer_4,
