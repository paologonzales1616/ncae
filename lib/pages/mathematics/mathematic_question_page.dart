...
import 'package:ncae/pages/mathematics/mathematics_answer_page.dart';

class MathematicsQuestionPage extends StatefulWidget {
  @override
  _MathematicsQuestionPageState createState() =>
      _MathematicsQuestionPageState();
}

class _MathematicsQuestionPageState extends State<MathematicsQuestionPage> {
  String answer_1 = "a"; //d
  String answer_2 = "a"; //b
  String answer_3 = "a"; //c
  String answer_4 = "a"; //a
                ...
                child: ButtonTheme(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MathematicsAnswerPage(
                          answer_1: answer_1,
                          answer_2: answer_2,
                          answer_3: answer_3,
                          answer_4: answer_4,
